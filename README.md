...
allowing you to friendly use and switch between mainstream LLM models (including Claude OPUS 4.6, GLM 5.2, Deepseek v4 pro, Deepseek v4 flash, Kimi K2.6, Minimax M3, Mimo 2.5 pro, etc.) within an ongoing session as needed, without interrupting your context.
